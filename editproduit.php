...
<div class="container">
  ...
  <div style="margin: 24%; position:fixed; top: -90px; left: -30px; right: 30px; position:fixed; ">
<!-- <div class="header-title" style="position:relative;top:90px; font-family:'Titillium Web', sans-serif;"><h2 align="center"><b>Ajouter un produit :<b></h2></div> -->
   ...
   <h3 class="text-center" style="font-family:'Titillium Web', sans-serif;" align="center"><b>Modifier : <span style="background-color:darkseagreen;"><?=$nom; ?><span></b></h3> 
  ...
  <fieldset class="" style="background-color: #f7f7f7; width:100%;  "><br>
    ...
    <div class="form-group">
      ...
      <textarea class="form-control"  name="nom" value="" required><?php echo $nom; ?></textarea>
    </div>
    </div><br>
    ...
    <div class="form-group">
      ...
      <div class="form-floating"><br>
        <textarea class="form-control" placeholder="ce contenu ne doit pas dépasser 255 caractère"  style="height: 100px" name="description" value="<?php echo $desc; ?>" required><?php echo $desc; ?></textarea>
      </div>
    </div><br>
    ...
    <div class="mb-3"><br>
    <img align="center" src="<?php echo $imageURL; ?>" width="150px" height="100px">
      <input class="form-control" type="file" name="file" value="<?php echo $imageURL;?>" required>
    </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="" align="center"><br>
        <input class="form-control" type="number" name="quantite" style="width:20%; font-size:20px;" value="<?php echo $qte; ?>" required >
...
if(isset($_POST['submit']) && !empty($_POST['categorie'])){
...
if (mysqli_query($conn, $updateq)) {
  ...
  echo'<script> location.replace("status.php?status=updated&&id='.$id.'",0); </script>';
...
//header('Location:listproduits.php?status=success')
...
<br><br>
    ...
    <div class="form-group">        
      <div class="d-grid gap-2 col-6 mx-auto" align="center">
        <button type="submit" class="btn btn-success" name="submit" onclick="return updateme()">Valider </button>
      </div>
    </div>
  </form>
  </div>
  ...
  <script language="javascript">
  function updateme(){
    if(confirm("Enregistrer ces modification ?")){
      windows.location.href='editproduit.php';
      return true;
    }else{
      return false;
    }
